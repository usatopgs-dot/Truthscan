...
export default function TruthScan() {
  ...
  return (
    <>
      <Head>
        ...
        <style>{`
          *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
          body { background:#0d0f1a; color:#e2e8f0; font-family:'DM Sans',sans-serif; -webkit-font-smoothing:antialiased; }
      ...
      <div style={{ minHeight:"100vh", background:"#0d0f1a", position:"relative", overflow:"hidden" }}>

        {/* Background effects */}
        <div style={{ position:"fixed", inset:0, pointerEvents:"none", zIndex:0 }}>
          <div style={{ position:"absolute", top:"-20%", left:"60%", width:600, height:600,
            background:"radial-gradient(circle, rgba(34,211,160,0.07) 0%, transparent 70%)", borderRadius:"50%" }} />
          <div style={{ position:"absolute", bottom:"-10%", left:"-10%", width:500, height:500,
            background:"radial-gradient(circle, rgba(129,140,248,0.06) 0%, transparent 70%)", borderRadius:"50%" }} />
          <div style={{ position:"absolute", top:"40%", right:"-5%", width:400, height:400,
            background:"radial-gradient(circle, rgba(255,77,109,0.05) 0%, transparent 70%)", borderRadius:"50%" }} />
          {/* Grid pattern */}
        ...
        <div style={{ position:"relative", zIndex:1, maxWidth:680, margin:"0 auto", padding:"32px 20px 60px" }}>
          ...
          <div style={{ textAlign:"center", marginBottom:44, animation:"fadeUp 0.6s ease" }}>
            ...
            <div style={{ display:"inline-flex", alignItems:"center", justifyContent:"center",
              ...
              background:"linear-gradient(135deg,rgba(34,211,160,0.15),rgba(8,145,178,0.1))",
              border:"1px solid rgba(34,211,160,0.2)",
              boxShadow:"0 0 40px rgba(34,211,160,0.12), inset 0 1px 0 rgba(255,255,255,0.05)" }}>
            ...
            <h1 style={{ fontFamily:"'Syne',sans-serif", fontSize:40, fontWeight:800, letterSpacing:"-0.02em",
              background:"linear-gradient(135deg,#f1f5f9 30%,#22d3a0 100%)",
              WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent",
              margin:"0 0 8px", lineHeight:1 }}>TruthScan</h1>
            <p style={{ color:"#475569", fontSize:13, letterSpacing:"0.15em", fontFamily:"'JetBrains Mono',monospace",
          ...
          {/* Main card */}
          <div style={{ background:"rgba(255,255,255,0.02)", border:"1px solid #1e293b", borderRadius:24,
            padding:24, marginBottom:12, backdropFilter:"blur(10px)",
            ...
            <div style={{ display:"flex", gap:4, marginBottom:20, padding:4,
              background:"rgba(0,0,0,0.2)", borderRadius:14, border:"1px solid #0f172a" }}>
              {TABS.map(t => (
                <button key={t.id}
            ...
            {tab === "text" && (
              <div>
                <label style={{ color:"#334155", fontSize:11, letterSpacing:"0.12em",
                ...
                <textarea value={textInput} onChange={e => setTextInput(e.target.value)}
                  ...
                  style={{ width:"100%", background:"transparent", border:"none", outline:"none",
                    color:"#cbd5e1", fontSize:15, lineHeight:1.8, resize:"none",
                    boxSizing:"border-box" }} />
                {textInput && (
                  <div style={{ display:"flex", justifyContent:"flex-end", marginTop:8 }}>
                    <span style={{ color:"#1e293b", fontSize:11, fontFamily:"'JetBrains Mono',monospace" }}>
            ...
            {tab === "url" && (
              <div>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:10,
                  ...
                  <input type="url" value={urlInput} onChange={e => setUrlInput(e.target.value)}
                    ...
                    style={{ flex:1, background:"transparent", border:"none", outline:"none",
                      color:"#cbd5e1", fontSize:15, padding:"10px 0" }} />
                  {urlInput && (
                ...
                <p style={{ color:"#1e293b", fontSize:12, marginTop:10, fontFamily:"'JetBrains Mono',monospace" }}>
              ...
              <div>
                ...
                {imagePreview ? (
                  ...
                  <div onClick={() => fileRef.current.click()}
                    style={{ border:"2px dashed #1e293b", borderRadius:14,
                      padding:"48px 20px", textAlign:"center", cursor:"pointer",
                      transition:"all 0.2s", background:"rgba(0,0,0,0.1)" }}
                    ...
                    <p style={{ color:"#1e293b", fontSize:12, fontFamily:"'JetBrains Mono',monospace" }}>JPG · PNG · WEBP · GIF</p>
                  </div>
                )}
          ...
          <button onClick={analyze} disabled={loading}
            ...
            style={{ width:"100%", padding:"16px", border:"none", borderRadius:16,
              ...
              boxShadow: loading ? "none" : "0 4px 20px rgba(34,211,160,0.2)",
          ...
          {result && vc && (
            <div style={{ animation:"fadeUp 0.5s ease" }}>
              ...
              <div style={{ padding:"24px", borderRadius:20, marginBottom:12,
                ...
                {/* Summary */}
                <div style={{ padding:"14px 16px", background:"rgba(0,0,0,0.2)", borderRadius:12, marginBottom:16,
                ...
                {result.source_credibility !== undefined && (
                  <div style={{ padding:"14px 16px", background:"rgba(0,0,0,0.15)", borderRadius:12, marginBottom:14,
                      ...
                      <div style={{ display:"flex", gap:2 }}>
                        {[1,2,3,4,5].map(i => (
                          <span key={i} style={{ fontSize:12,
                            color: i<=Math.round(result.source_credibility/20) ? "#fbbf24" : "#1e293b" }}>★</span>
                        ))}
                ...
                {tl && (
                  <div style={{ display:"inline-flex", alignItems:"center", gap:8,
                    ...
                    background:"rgba(0,0,0,0.2)", border:"1px solid #0f172a" }}>
                ...
                <div style={{ marginBottom:16 }}>
                  <div style={{ color:"#1e293b", fontSize:10, letterSpacing:"0.15em",
          ...
          {/* Add key CTA */}
          {!apiKey && (
            <div style={{ padding:"22px", border:"1px dashed #1e293b", borderRadius:20,
          ...
          {/* Footer */}
          <p style={{ textAlign:"center", color:"#1e293b", fontSize:11,
      ...
      {showShare && result && vc && (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.85)", backdropFilter:"blur(8px)",
          ...
          <div style={{ background:"#111827", border:"1px solid #1e293b", borderRadius:24, padding:28,
            maxWidth:420, width:"100%", boxShadow:"0 24px 80px rgba(0,0,0,0.6)", animation:"fadeUp 0.3s ease" }}>
            <h2 style={{ color:"#f1f5f9", fontFamily:"'Syne',sans-serif", fontSize:18, fontWeight:700, marginBottom:20 }}>Share Result</h2>
            <div style={{ padding:18, background:vc.bg, border:`1px solid ${vc.color}25`, borderRadius:16, marginBottom:20 }}>
            ...
            <div style={{ display:"flex", gap:10 }}>
              <button onClick={() => setShowShare(false)}
                style={{ flex:1, padding:12, background:"transparent", border:"1px solid #1e293b",
        ...
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.85)", backdropFilter:"blur(8px)",
          ...
          <div style={{ background:"#111827", border:"1px solid #1e293b", borderRadius:24, padding:28,
            ...
            <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:20 }}>
              ...
              <div>
                <h2 style={{ color:"#f1f5f9", fontFamily:"'Syne',sans-serif", fontSize:17, fontWeight:700, margin:0 }}>Add API Key</h2>
            ...
            <div style={{ padding:"10px 14px", background:"rgba(34,211,160,0.04)",
              border:"1px solid rgba(34,211,160,0.12)", borderRadius:10, marginBottom:20 }}>
            ...
            <div style={{ display:"flex", gap:10 }}>
              <button onClick={() => { setShowModal(false); setTempKey(""); }}
                style={{ flex:1, padding:13, background:"transparent", border:"1px solid #1e293b",
                  borderRadius:12, color:"#475569", cursor:"pointer", fontSize:13 }}>Cancel</button>
