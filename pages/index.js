        ...
        <div style={{ position:"relative", zIndex:1, maxWidth:660, margin:"0 auto" }}>
          ...
          <div style={{ textAlign:"center", marginBottom:36, animation:"fadeUp 0.5s ease" }}>
            ...
            <div style={{ display:"flex", justifyContent:"center", gap:8, marginTop:18 }}>
              ...
              <Link href="/trending" style={{ padding:"6px 18px", borderRadius:20,
                background:"#fff7ed", border:"1px solid #fed7aa",
                color:"#ea580c", fontSize:13, fontWeight:500 }}>
                📈 Trending
              </Link>
              <Link href="/blog" style={{ padding:"6px 18px", borderRadius:20,
                background:"#f0f9ff", border:"1px solid #bae6fd",
                color:"#0891b2", fontSize:13, fontWeight:500 }}>
                📝 Blog
              </Link>
            </div>
          ...
          {/* ✅ Ad after result — best placement */}
          {result && vc && <AdBanner />}
          ...
          <div style={{ marginTop:32, paddingTop:20, borderTop:"1px solid #f1f5f9", textAlign:"center" }}>
            <p style={{ color:"#cbd5e1", fontSize:11, fontFamily:"'JetBrains Mono',monospace", marginBottom:12 }}>
            ...
            <p style={{ color:"#e2e8f0", fontSize:11, marginTop:12 }}>
              © 2026 TruthScan · <a href="https://frontendin.com" style={{ color:"#94a3b8" }}>frontendin.com</a>
            </p>
          </div>
        </div>
      </div>
